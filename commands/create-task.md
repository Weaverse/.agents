...
3. **Issue details** - Repo, title, assignees, description
4. **Metadata** - Status, priority, labels, milestone, issue type
5. **Create & configure** - Create the issue, set type, add to project with field values
6. **Confirm** - Output a summary with the issue URL and all metadata
